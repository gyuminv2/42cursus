...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm &instance): Form("shrubbery creation", instance.getRequiredGrade(), instance.getExecuteGrade())
{}
