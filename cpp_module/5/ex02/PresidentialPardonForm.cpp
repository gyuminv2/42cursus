...
PresidentPardonForm::PresidentPardonForm() : Form("PresidentPardonForm", 25, 5)
{
}

PresidentPardonForm::PresidentPardonForm(const PresidentPardonForm &instance): Form("PresidentPardonForm", instance.getRequiredGrade(), instance.getExecuteGrade())
{}
