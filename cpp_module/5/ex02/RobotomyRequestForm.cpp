...
RobotomyRequestForm::RobotomyRequestForm(const RobotomyRequestForm &instance):Form("RobotomyRequestForm", instance.getRequiredGrade(), instance.getExecuteGrade())
{}
